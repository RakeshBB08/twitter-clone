...
//   alert("ChurMuri");
// });
// when document loads all the files it alerts the user
var cropper;
var timer;
var selectedUsers = [];
...
$("#deletePostButton").click((event) => {
  ...
  $.ajax({
    // this is same as $.post("/api/posts", Data,()=>{})
...
$("#imageUploadButton").click(() => {
  ...
  // Blob-> Binary Large Object used by utube to store large images
  canvas.toBlob((blob) => {
    ...
    $.ajax({
      ...
      type: "POST",
      data: formData,
      processData: false, //this prevents jquery conversion from data to string
      contentType: false,
...
createPostHtml = function (postData, largeFont = false) {
  ...
  // console.log(postData.postedBy.firstName);
  ...
  var retweetText = "";
  if (isRetweet) {
    retweetText = `<span class= 'retweetText'>
  ...
  if (postData.postedBy._id == userLoggedIn._id) {
    ...
    buttons = `
    <button class='pinButton ${pinnedClass}' data-bs-id = "${postData._id}" data-bs-toggle = "modal" data-bs-target="${dataTarget}"><i class="fas fa-thumbtack"></i></button>
    <button data-bs-id = "${postData._id}" data-bs-toggle = "modal" data-bs-target="#deletePostModal"><i class="fas fa-times"></i></button>`;
  }
...
function getChatName(chatData) {
  ...
  if (!chatName) {
    ...
    var nameArray = otherChatUsers.map(
...
function getNotificationText(notification) {
  ...
  if (!userFrom.firstName || !userFrom.lastName) {
    return alert("user from is not populated");
  }
...
function getUserChatImageElement(user) {
  ...
  return `<img src='${user.profilePic}' alt = 'User's profiel pic'>`;
}
