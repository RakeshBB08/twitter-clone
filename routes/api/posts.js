...
router.get("/", async (req, res, next) => {
  ...
  if (searchObj.search !== undefined) {
    // regex is called for alike objects searching,options provided for ignoring casetype
...
router.post("/", async (req, res, next) => {
  if (!req.body.content) {
    console.log("Content parameter was not sent with the request");
...
router.put("/:id/like", async (req, res, next) => {
  // console.log(req.params.id); // same as in the first para
  var postId = req.params.id;
